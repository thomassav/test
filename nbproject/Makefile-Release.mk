...
${OBJECTDIR}/cplx.o: cplx.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cplx.o cplx.c
...
${OBJECTDIR}/cplx_nomain.o: ${OBJECTDIR}/cplx.o cplx.c 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/cplx.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cplx_nomain.o cplx.c;\
	else  \
	    ${CP} ${OBJECTDIR}/cplx.o ${OBJECTDIR}/cplx_nomain.o;\
	fi
